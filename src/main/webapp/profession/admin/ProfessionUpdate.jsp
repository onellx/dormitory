                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="${pageContext.request.contextPath}/profession/professionUpdate.action" method="post">
                                    <input type="hidden" name="professionId" value="${professionInfo.professionId }" />

									<div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">专业编号<span class="tpl-form-line-small-title">Id</span></label>
                                        <div class="am-u-sm-9">
                                            <small>${professionInfo.professionId }</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" class="tpl-form-input" id="user-name" name="professionName" value="${professionInfo.professionName }">
                                            <small>输入专业名称</small>
                                        </div>
                                    </div>
                                        ...
                                        <div class="am-u-sm-9">
                                            <select data-am-selected="{searchBox: 1}" style="display: none;" name="collegeId">
                                              <c:forEach var="college" items="collegeList">
                                                    <c:choose>
                                                        <c:when test="${college.collegeId == professionInfo.collegeId}">
                                                        <option selected="selected" value="${college.collegeId }">${college.collegeName }</option>
                                                        </c:when>
                                                        <c:otherwise>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="professionLinkman" value="${professionInfo.professionLinkman }">
                                            <small>专业联系人</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="professionTel" value="${professionInfo.professionTel }">
                                            <small>专业联系人电话</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="professionIntro" value="${professionInfo.professionIntro }">
                                            <small>专业介绍</small>
                                        </div>
                                    </div>
