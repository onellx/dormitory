...
<head>
    ...
    <title>学制列表</title>
    <meta name="description" content="学制列表">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-striped am-table-bordered am-table-compact " id="example">
                                        ...
                                        <tbody>
                                            <c:forEach  varStatus="i" var="systemInfo" items="${systemList }">
                                            <tr class="gradeX">
                                                <td>${systemInfo.systemId }</td>
                                                <td>${systemInfo.systemName }</td>
                                                <td>${systemInfo.systemYears }</td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="${pageContext.request.contextPath}/systemInfo/findSystemInfo.action?systemId=${systemInfo.systemId }">
