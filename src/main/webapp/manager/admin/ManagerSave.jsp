...
<head>
    ...
    <title>新增管理员账号</title>
    <meta name="description" content="新增管理员账号">
            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        ...
                        <p class="page-header-description">新增管理员账号</p>
                    </div>
                </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">新增管理员账号</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="${pageContext.request.contextPath}/manager/managerSave.action" method="post">

                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">姓名 <span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="managerName" placeholder="请输入账号姓名">
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">姓名 <span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="managerName" placeholder="请输入账号密码">
                                            <small>请填写账号密码</small>
                                        </div>
                                    </div>
