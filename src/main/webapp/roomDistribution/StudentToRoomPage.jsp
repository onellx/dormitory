                ...
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        ...
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> Dormitory <small>寝室</small></div>
                            ...
                            <form class="am-form tpl-form-line-form" action="${pageContext.request.contextPath}/roomDistribution/studentToRoom.action" method="post" id="queryform">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <label for="user-name" class="am-u-sm-3 am-form-label">分配到</label>
                                                <div class="am-u-sm-9">
                                                    <select data-am-selected="{searchBox: 1}" style="display: none;" name="roomId" id="roomId">
                                                        <c:forEach var="dormroom" items="${dormroomList }">
                                                        <option value="${dormroom.roomId }">${dormroom.dormId } 栋 ${dormroom.roomNum }</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
