                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-striped am-table-bordered am-table-compact " id="example">
                                        ...
                                        <tbody>
                                            <c:forEach  varStatus="i" var="moduleInfo" items="${moduleList }">
                                            <tr class="gradeX">
                                                <td>${moduleInfo.moduleId }</td>
                                                <td>${moduleInfo.moduleName }</td>
                                                <td>${moduleInfo.mostate }</td>
                                                <td></td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="${pageContext.request.contextPath}/module/findModuleInfo.action?moduleId=${moduleInfo.moduleId }">
