...
<head>
    ...
    <title>宿舍房间列表</title>
    <meta name="description" content="宿舍房间列表">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-success" onclick="javascript:window.location='${pageContext.request.contextPath}/dormroom/dormroomSavepage.action'"><span class="am-icon-plus"></span> 新增</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table width="100%"  class="am-table am-table-striped am-table-bordered am-table-compact" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>${dormroom.dormId }</td>
                                                <td>${dormroom.roomUsecondition.equals("1")?"启用":"禁用" }</td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="${pageContext.request.contextPath}/dormroom/findDormroomInfo.action?roomId=${dormroom.roomId }">
